...
public static int save(student_info bean){
	int status=0;
	try{
...
public static int update(student_info bean){
	int status=0;
	try{
		Connection con=database.getCon();
...
public static List<student_info> getAllRecords(){
	...
	try{
		...
		while(rs.next()){
			student_info bean=new student_info();
...
public static List<student_info> getDues(){
	List<student_info> list=new ArrayList<student_info>();
	try{
		Connection con=database.getCon();
...
public static student_info getRecordByRollno(int rollno){
	student_info bean=new student_info();
	try{
		Connection con=database.getCon();
