...
public class viewstudent extends HttpServlet {
  ...
  out.println("<script src=\"https://code.iconify.design/1/1.0.7/iconify.min.js\"></script>");
		...
		out.println("<body>");
                out.println("<center>");
		out.println("<br>");
                 out.print("<a class='btn btn-primary' href=\"accountantportal.html\" >");
		...
		for(student_info bean:list){
			out.print("<tr><td>"+bean.getRollno()+"</td><td>"+bean.getName()+"</td><td>"+bean.getEmail()+"</td><td>"+bean.getSex()+"</td><td>"+bean.getCourse()+"</td><td>"+bean.getFee()+"</td><td>"+bean.getPaid()+"</td><td>"+bean.getDue()+"</td><td>"+bean.getAddress()+"</td><td>"+bean.getContact()+"</td><td><a class=\"btn btn-info\" href='editstudentform?rollno="+bean.getRollno()+"'><span class=\"iconify\" data-icon=\"fa-solid:edit\" data-inline=\"false\"></span>Edit</a></td><td><a class=\"btn btn-danger\" href='deletestudent?rollno="+bean.getRollno()+"'><span class=\"iconify\" data-icon=\"ic:baseline-delete\" data-inline=\"false\"></span>Delete</a></td></tr>");
		}
		out.println("</table>");
